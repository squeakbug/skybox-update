...
RUnit::RUnit(const SimContext& ctx, Core* core)
	: FuncUnit(ctx, core, "raster-unit")
{
	// bind raster unit
}
...
TUnit::TUnit(const SimContext& ctx, Core* core)
	: FuncUnit(ctx, core, "tex-unit")
{
	// bind tex unit
}
...
OUnit::OUnit(const SimContext& ctx, Core* core)
	: FuncUnit(ctx, core, "om-unit")
{
	// bind om unit
}
