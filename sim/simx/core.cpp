...
#ifdef EXT_RASTER_ENABLE
            } else if (std::get_if<RasterType>(&use.op_type)) {
              ++perf_stats_.scrb_raster;
#endif
#ifdef EXT_TEX_ENABLE
            } else if (std::get_if<TexType>(&use.op_type)) {
              ++perf_stats_.scrb_tex;
#endif
#ifdef EXT_OM_ENABLE
            } else if (std::get_if<OmType>(&use.op_type)) {
              ++perf_stats_.scrb_om;
#endif
            }
          } break;
